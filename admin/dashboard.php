...
$conn->close();
													...
													<div class="stat-panel-title text-uppercase">No-of-Students</div>
												</div>
											</div>
...
$conn->close();
													...
													<div class="stat-panel-title text-uppercase">Request Need To Be Approved</div>
												</div>
											</div>
											<a href="access-log.php" class="block-anchor panel-footer text-center">See All &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
